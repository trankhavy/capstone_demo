...
from tensorflow.keras.layers import Input, BatchNormalization, Activation, Dense, Dropout,Conv2D, \
Conv2DTranspose,MaxPooling2D, GlobalMaxPool2D, concatenate, Add, UpSampling2D
...
def build_model(input_size=(IMG_SIZE, IMG_SIZE, IMG_CHANNELS)):
